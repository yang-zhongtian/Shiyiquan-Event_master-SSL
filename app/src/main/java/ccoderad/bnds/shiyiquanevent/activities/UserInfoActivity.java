    ...
    * */
    private boolean parseUserInfo(String jsonString) {
        try {
            ...
            if (userData.has(UserInfoConstants.ContactUser.REG_TIME_TAG)) {
                String regTime = userData.getString(UserInfoConstants.ContactUser.REG_TIME_TAG);
                mUserRegTime.setText(regTime);
            } else {
                mUserRegTime.setVisibility(View.GONE);
            }
            mUserVisCount.setText(visCount);
            Log.i("userData", Boolean.toString(userData.has("badge_list")));
            if (userData.has(UserInfoConstants.FRIEND_TAG)) {
                ...
                for (int i = 0; i < contactUsers.length(); ++i) {
                    ...
                    String avatarUrl = conUser.getJSONObject(UserInfoConstants
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * */
        ...
        Log.i("Sessionid", PreferenceUtils.getString(UserInfoActivity.this
                , "LoginInfo"
                , PreferencesConstants.USER_SESSION_ID, "null"));
        StringRequest request = new StringRequest(Request.Method.GET, userHome, new Response.Listener<String>() {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                return Utils.createDefaultExtraHeader(UserInfoActivity.this);
            }
        };
