...
import ccoderad.bnds.shiyiquanevent.activities.UserInfoActivity;
...
public class Utils {
    ...
    public static Map<String, String> createExtraHeader(String[] keys , String[] values){
    ...
    public static Map<String, String> createDefaultExtraHeader(Context context){
        return createExtraHeader(new String[]{"Json", "cookie"}
                , new String[]{"true"
                        , "sessionid=" + PreferenceUtils.getString(context
                        , "LoginInfo"
